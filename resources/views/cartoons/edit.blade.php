    ...
    <form action="{{route('cartoons.update', $cartoon)}}" method="POST">
        ...
        <div class="mb-3">
          ...
          <div class="mb-3">
              ...
              <input type="number" class="form-control @error('runtime_in_minutes') is-invalid @enderror" name="runtime_in_minutes" id="runtime_in_minutes" value="{{old('runtime_in_minutes',$cartoon->runtime_in_minutes)}}" placeholder="Insert minutes..">
